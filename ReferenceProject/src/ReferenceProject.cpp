...
void functionToPrintBismar1(int *bis) {
	cout<<"\nfunctionToPrintBismar1: [value of bismar : ]"<<*bis;

	cout<<"\nbis is holding a value : "<<bis;
	cout<<"\nbis is stored at       : "<<&bis;
	cout<<"\n=========";
	//bis = new int;
}

void functionToPrintBismar2(int &bis) {
	cout<<"\nfunctionToPrintBismar2: [value of bismar : ]"<<bis;
...
int main() {
	...
	functionToPrintBismar1(&bismar);
	functionToPrintBismar2(bismar);
